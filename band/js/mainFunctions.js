...
window.addEventListener("load", function () {
  if (document.getElementById('insertMail')) {
    let name = "info" ; // Update yours informations here
    let domain = "exposed-to-reality.de" ; // Update yours informations here
    ...
    $players.each(function () {
      ...
      $play.on('click', function () {
        if (audio.paused) {
          ...
          $('.audioPlayer audio').not(audio).each(function () { this.pause(); });
          audio.play();
        } else {
          audio.pause();
        }
